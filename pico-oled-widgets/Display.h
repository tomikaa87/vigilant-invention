...
public:
    ...
    static void sendData(const uint8_t* data, size_t length, uint8_t bitShift = 0, bool invert = false)
    {
...
#ifdef CONFIG_DISPLAY_CONTROLLER_SH1106
#include "Driver_SH1106.h"
using Display = DisplayImpl<
    Driver::SH1106<
        I2cAdapter<i2c1>
    >
>;
#elif defined CONFIG_DISPLAY_CONTROLLER_SSD1306
#include "Driver_SSD1306.h"
using Display = DisplayImpl<
    Driver::SSD1306<
        I2cAdapter<i2c1>,
        Driver::SSD1306_Resolution::R128x64_P8
    >
>;
#else
#error Display controller must be selected
#endif